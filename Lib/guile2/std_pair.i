...
namespace std {
    ...
    specialize_std_pair_on_first(bool,scm_is_boolean,
                              scm_to_bool,scm_from_bool);
    ...
    specialize_std_pair_on_second(bool,scm_is_boolean,
                                scm_to_bool,scm_from_bool);
    ...
    specialize_std_pair_on_both(bool,scm_is_boolean,
                               scm_to_bool,scm_from_bool,
                               bool,scm_is_boolean,
                               scm_to_bool,scm_from_bool);
    specialize_std_pair_on_both(bool,scm_is_boolean,
